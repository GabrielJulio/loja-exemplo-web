  ...
  return (
    <div className="app">
      <header className="app-header">
        <img src="logo538.png" className="app-logo" alt="logo" height="128px"/>
      </header>
      <section className="politica-de-privacidade">
        <h1>Política Privacidade</h1>
        <p>
          A sua privacidade é importante para nós.
          É política do Loja Exemplo respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no aplicativo&nbsp;
          <a href="https://oja-virtual-exemplo.web.app">Loja Exemplo</a>, e outros sites que possuímos e operamos.
        </p>
        <p>
        ...
        <h2>Política de Cookies Loja Exemplo</h2>
        ...
        <p>
          ...
          A desativação de cookies geralmente resultará na desativação de determinadas funcionalidades e recursos deste site.
        ...
        <ul>
          ...
          <li>
            ...
            Essas pesquisas podem usar cookies para lembrar quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.
            <br/><br/>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            Esses cookies podem rastrear itens como quanto tempo você gasta no site e as páginas visitadas, para que possamos continuar produzindo conteúdo atraente.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            Quando ainda estamos testando novos recursos, esses cookies podem ser usados ​​para garantir que você receba uma experiência consistente enquanto estiver no site,&nbsp;
        ...
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Loja Exemplo oferece no site e com caráter enunciativo, mas não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou sobre cassinos, casas de apostas online (ex.: Betway), jogos de sorte e azar,&nbsp;
            qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
          </li>
          <li>
            C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Loja Exemplo, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou&nbsp;
        ...
        <p>
          Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados,
          caso interaja com um dos recursos que você usa em nosso site.
        </p>
        <p>
          Esta política é efetiva a partir de <strong>Março</strong>/<strong>2021</strong>.
        </p>
      </section>
      <hr/>
      <section className="termos-de-uso">
        <h1>Termos de Uso</h1>
        <h2>1. Termos</h2>
        <p>Ao usar o aplicativo <a href="https://loja-virtual-exemplo.web.app">Loja Exemplo</a>, concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis ​​e&nbsp;
        concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido de usar ou acessar este site.
        Os materiais contidos neste site são protegidos pelas leis de direitos autorais e marcas comerciais aplicáveis.
      </p>
      <h2>2. Uso de Licença</h2>
      <p>
        É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site Loja Exemplo, apenas para visualização transitória pessoal e não comercial.
      ...
      <ol>
        ...
        <li>
          tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Loja Exemplo;
        </li>
        <li>
        ...
        <p>
          Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser rescindida por Loja Exemplo a qualquer momento.
        ...
        <ol>
          <li>
            Os materiais no site da Loja Exemplo são fornecidos 'como estão'. Loja Exemplo não oferece garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras garantias,&nbsp;
            incluindo, sem limitação, garantias implícitas ou condições de comercialização, adequação a um fim específico ou não violação de propriedade intelectual ou outra violação de direitos.
          </li>
          <li>
            Além disso, o Loja Exemplo não garante ou faz qualquer representação relativa à precisão, aos resultados prováveis ​​ou à confiabilidade do uso dos materiais em seu site ou de outra forma&nbsp;
          ...
          <h2>4. Limitações</h2>
          <p>
            Em nenhum caso o Loja Exemplo ou seus fornecedores serão responsáveis ​​por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios)&nbsp;
            decorrentes do uso ou da incapacidade de usar os materiais em Loja Exemplo, mesmo que Loja Exemplo ou um representante autorizado da Loja Exemplo tenha sido notificado oralmente ou&nbsp;
            por escrito da possibilidade de tais danos. Como algumas jurisdições não permitem limitações em garantias implícitas, ou limitações de responsabilidade por danos conseqüentes ou incidentais,&nbsp;
            essas limitações podem não se aplicar a você.
          </p>
          <h2>5. Precisão dos materiais</h2>
          <p>
            Os materiais exibidos no site da Loja Exemplo podem incluir erros técnicos, tipográficos ou fotográficos.
            Loja Exemplo não garante que qualquer material em seu site seja preciso, completo ou atual.
            Loja Exemplo pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio.
            No entanto, Loja Exemplo não se compromete a atualizar os materiais.
          </p>
          <h2>6. Links</h2>
          <p>
            O Loja Exemplo não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo de nenhum site vinculado.
            A inclusão de qualquer link não implica endosso por Loja Exemplo do site. O uso de qualquer site vinculado é por conta e risco do usuário.
          </p>
        
        <h3>Modificações</h3>
        <p>
          O Loja Exemplo pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio.
          Ao usar este site, você concorda em ficar vinculado à versão atual desses termos de serviço.
        </p>
        <h3>Lei aplicável</h3>
        <p>
          Estes termos e condições são regidos e interpretados de acordo com as leis do Loja Exemplo e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele estado ou localidade.
        </p>
      </section>
    </div>
  );
